      ...
      <div className="iconsContainer">
        ...
        <div className="ourIconContainer">
          <div className="ourIcon">
            <img src={image.spicy} alt="spicy" className="icon" />
            <img src={image.spicyBig} alt="spicyBig" className="iconBig" />
            <h1 className="label">Spicy</h1>
          </div>

          <div className="ourIcon">
            <img src={image.vegetarian} alt="vegitarian" className="iconVegitarian" />
          ...
          <div className="ourIcon">
            <img src={image.vegan} alt="vegan" className="icon" />
